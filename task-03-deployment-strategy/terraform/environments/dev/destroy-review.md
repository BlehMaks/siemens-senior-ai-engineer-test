...
Cloud Run deletion protection must also be disabled before removing the execution
plane. These explicit changes keep destructive intent out of routine environment
cleanup.
